...
@Entity
@Table(name="main_stock_units")
public class MainStockUnits {
	...
	public String toString() {
		return "MainStockUnits [date=" + date + ", NESTOMALT_ACTIGEN=" + NESTOMALT_ACTIGEN + ", NESPRAY_EVERYDAY="
	...
	public MainStockUnits(String date, int nESTOMALT_ACTIGEN, int nESPRAY_EVERYDAY, int mILKMAID_SWT_COND_MILK,
